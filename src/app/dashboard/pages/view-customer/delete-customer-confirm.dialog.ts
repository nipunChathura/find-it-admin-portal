...
export interface DeleteCustomerConfirmData {
  customerName: string;
}
...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <p class="delete-customer-confirm__hint">This action cannot be undone.</p>
    </mat-dialog-content>
...
export class DeleteCustomerConfirmDialogComponent {
  readonly data: DeleteCustomerConfirmData = inject(MAT_DIALOG_DATA);
  private readonly dialogRef = inject(MatDialogRef<DeleteCustomerConfirmDialogComponent>);
